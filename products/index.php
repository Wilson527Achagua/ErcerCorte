...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dashboard-container">
            ...
            <!-- Added search bar for filtering products by ID, name, or product name -->
            ...
            <!-- Replaced table with card grid layout -->
            <div class="products-grid" id="productsGrid">
                ...
                <div class="product-card" data-id="<?php echo htmlspecialchars($product->id_producto); ?>" data-name="<?php echo htmlspecialchars($product->nombre); ?>" onclick="toggleCard(this)">
                    <div class="product-image">
                        ...
                        <img src="../uploads/<?php echo htmlspecialchars($product->imagen); ?>" alt="<?php echo htmlspecialchars($product->nombre); ?>">
                        <?php else: ?>
                        Sin imagen
                        <?php endif; ?>
                    </div>
                    ...
                    <!-- Added expandable details section with all product info and actions -->
