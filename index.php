...
// ARREGLO: Se cambia iterator_count() por count()
$totalClients = count($db->executeQuery('clients', []));
$totalProducts = count($db->executeQuery('products', []));
$totalSales = count($db->executeQuery('sales', []));
