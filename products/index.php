...
                    <div class="product-image">
                        <?php 
                        // Corregido: Si existe la URL de Cloudinary, úsala directamente.
                        // La base de datos ahora guarda la URL completa, no solo el nombre del archivo.
                        $imageUrl = !empty($product->imagen) ? htmlspecialchars($product->imagen) : 'placeholder.png';
                        ?>
